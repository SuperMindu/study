...
# train 데이터 불러오기
train_set = pd.read_csv('./_data/dacon_shopping/train.csv')

# test 데이터 불러오기
test_set = pd.read_csv('./_data/dacon_shopping/test.csv')

# sample_submission 불러오기
submission_set = pd.read_csv('./_data/dacon_shopping/sample_submission.csv')
...
# loss :    263427129344.0                 261907038208.0                      263190233088.0                  287925927936.0                                                                                          
# RMSE :    513251.4849125104              511768.51565329975                  513020.7366907224               536587.3074660796                                                                  