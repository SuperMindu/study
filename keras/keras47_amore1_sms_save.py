...
output2 = Dense(32, activation='relu', name='out_ms2')(dense13)
...
hist = model.fit([x1_train, x2_train], y1_train, epochs=1000, batch_size=128, validation_split=0.15, callbacks=[es,mcp], verbose=1)
