...
hist = model.fit(x_train, y_train, epochs=1000, batch_size=8, validation_split=0.1, callbacks=[es] ,verbose=1) # 이렇게 하려면 배치사이즈를 최대로 잡아주면 됨
...
# loss :  0.02647634968161583
# val_loss :  7.6772918701171875
# accuracy :  0.9864559769630432
# val_accuracy :  0.5
